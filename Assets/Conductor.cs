...
//internal class WebRTCScript : MonoBehaviour
//{
//#if ENABLE_WINMD_SUPPORT
...
//#if ENABLE_WINMD_SUPPORT
//    private void PeerConnection_OnConnectionHealthStats(RTCPeerConnectionHealthStats evt)
//    {
//    }
...
//        };
//        Debug.Log("Conductor: Sending ice candidate.\n" + json.Stringify());
//        SendMessage(json);
//    }
